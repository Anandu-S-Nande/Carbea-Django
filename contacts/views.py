...
def inquiry(request):
    if request.method == 'POST':
        ...
        # admin_info = User.objects.get(is_superuser=True) ##########ERROR MAKES
        # admin_email = admin_info.email
        # send_mail(
        #         'New Car Inquiry',
        #         'You have a new inquiry for the car ' + car_title + '. Please login to your admin panel for more info.',
        #         'anandusnande@gmail.com',
        #         [admin_email],
        #         fail_silently=False,
        #     )    ######################################
        contact.save()
        messages.success(request, 'Your request has been submitted, we will get back you shortly.')
        return redirect('/cars/'+car_id)
